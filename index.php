        ...
        <nav class="navbar navbar-default" role="navigation" style="background-color: white; padding-top: 0px;">
            <div class="container-fluid">
                 ...
                 <div class="navbar-header">
                    ...
                    <a class="navbar-brand " style="color: black; margin: 0px 0px; font-size: 15px; padding: 10px;" href="index.php"><p style="color: hsla(214, 60%, 44%,1); display: inline; font-size: 30px; font-weight: bold;">Best</p> Offer <span class="glyphicon glyphicon-stats"></span>
                    </a>
...
$sql = mysqli_query($conn , "SELECT * FROM `posts` p INNER JOIN `users` u WHERE p.p_author = u.u_id ORDER BY `p_id` DESC LIMIT $start_f , $per_page ");
